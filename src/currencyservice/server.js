...
const options = {
  ...
  tags: [], // optional
  host: process.env.JAEGER_SERVICE_HOST, // optional
  port: process.env.JAEGER_SERVICE_PORT, // optional
...
if(process.env.DISABLE_TRACING) {
  ...
  console.log("Jaeger addr: " + options.host + ":" + options.port)
  ...
  try {
    _getCurrencyData((data) => {
      ...
      childSpan = tracing.tracer.startChildSpan({
        name: 'Round currency (' + from.currency_code + ')',
        units: from.units
      });
